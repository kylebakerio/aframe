...
We can use a `<canvas>` as a texture source. If the canvas if modified, you'll need to refresh the canvas by using code that follows the example shown [here](https://github.com/aframevr/aframe/blob/b164623dfa0d2548158f4b7da06157497cd4ea29/examples/test/canvas-texture/components/canvas-updater.js)
